      ...
      <div className="d-grid grid-autofit-md">
        ...
        <div className="subscribe flex-col">
          <h3 className="txt-white">
            Subscribe to get updates about latest offers
          </h3>
        ...
        <div className="d-flex justify-c-center gap-sm">
          <ul className="footer-links flex-col">
            ...
            <Link to="/wishlist" className="tr-btn tr-btn-link">
              Wishlist
            </Link>
            <Link to="/cart" className="tr-btn tr-btn-link">
              Cart
            </Link>
          ...
          <ul className="footer-links flex-col">
            ...
            <Link to="/products/Bats" className="tr-btn tr-btn-link">
              Bats
            </Link>
            <Link to="/products/Balls" className="tr-btn tr-btn-link">
              Balls
            </Link>
